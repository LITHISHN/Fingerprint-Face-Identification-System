...
# Database images
DB=["Database\\1_1.png", "Database\\1_2.png","Database\\1_3.png"]
source_images=["Fingerprints\\1_1.png","Fingerprints\\1_2.png","Fingerprints\\1_3.png"]
# User names and ride modes
User_list=["Lithish","Sathish","Mathi"]
Ride_mode=["Eco", "Comfort", "Sport"]
User = -1 # initialize to select no user
...
for count in range(0, 3):
    ...
    fig.canvas.manager.set_window_title(' Fingerprint Identification System')
    plot_img.show()
...
print("fingerPrint: ",User_list[User])

# \======================== Applying and matching=========================================/

#/=========================== Facial Recognition ===========================================\
faceinp =['TestImages/Lithish.jpg', 'TestImages/Sathish.jpg', 'TestImages/Mathi.jpg']

faceid=te.runFaceDetection(faceinp[choice])
print("faceid: ",faceid)
...
window.title("Enhanced Vehicle User System")
window.configure(bg="black")
User_image1=ImageTk.PhotoImage(Image.open("Lithish.jpg"))
User_image2=ImageTk.PhotoImage(Image.open("Sathish.jpg"))
User_image3=ImageTk.PhotoImage(Image.open("Mathi.jpg"))
User_images=[User_image1,User_image2,User_image3]
usrimg=User_images[User]

if(User_list[User] == faceid):
    fstr="Match Found, Welcome!! "+User_list[User]
    usricon=usrimg
    access_icon=ImageTk.PhotoImage(Image.open("accessgranted.png"))
else:
    fstr="User Missmatch"
    usricon=ImageTk.PhotoImage(Image.open("devil_user.png"))
    access_icon=ImageTk.PhotoImage(Image.open("accessdenied.png"))

label=tk.Label(window,text=(fstr+"\nFinger Print user: "+User_list[User]+"\nFace recognition user: "+faceid),font=("Arial",30),bg="gray",fg="white")
label.pack(side="top")

label1=tk.Label(window,image=usricon).pack(side="right")
label_speedo=tk.Label(window,image=access_icon).pack(side="left",padx=200)
